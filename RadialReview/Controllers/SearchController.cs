...
namespace RadialReview.Controllers {
	public class SearchController : BaseController {
		...
		[Access(AccessLevel.UserOrganization)]
		public JsonResult RGM(string search) {
			return Json(SearchAccessor.SearchOrganizationRGM(GetUser(), GetUser().Organization.Id, search), JsonRequestBehavior.AllowGet);
		}
	}
}