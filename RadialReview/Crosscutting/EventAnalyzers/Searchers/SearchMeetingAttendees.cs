...
namespace RadialReview.Crosscutting.EventAnalyzers.Searchers {
	...
	public class SearchHistoricalRecurrenceAttendeeIds : BaseSearch<List<IHistoricalImpl>> {
		public long RecurrenceId { get; set; }
		public SearchHistoricalRecurrenceAttendeeIds(long recurrenceId) {
			RecurrenceId = recurrenceId;
		}

		public override async Task<List<IHistoricalImpl>> PerformSearch(IEventSettings settings) {
			//L10Meeting alias = null;
