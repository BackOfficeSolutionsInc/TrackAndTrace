...
namespace RadialReview.Accessors {
	public class AccountabilityAccessor : BaseAccessor {
		...
		protected static AngularAccountabilityNode Dive(UserOrganizationModel caller, long nodeId, List<AccountabilityNode> nodes,
			...
			//TODO: need this line for AC pdf
			...
			aan.SetChildren(children.Select(x => Dive(caller, x.Id, nodes, groups, rolesLU, links, positions, teams, parentsCopy, allManagingUserIds, selectedNode, editableBelow, expandAll, editSelf)).ToList());
			return aan;
		}
