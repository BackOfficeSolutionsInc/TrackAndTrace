angular.module('VtoApp').controller('VtoController', ['$scope', '$http', '$timeout', 'signalR', 'vtoDataUrlBase', 'vtoId', "vtoCallback",
function ($scope, $http, $timeout, signalR, vtoDataUrlBase, vtoId, vtoCallback) {
	if (vtoId == null)
