    ...
    fcsaNumberModule.directive('fcsaNumber', [
      'fcsaNumberConfig', function (fcsaNumberConfig) {
          ...
          resize = function (val) {
              ...
              if (absV >= 1000000000) {
                  return { val: Math.round(val / 10000000) / 100 + "B", skipComma: true };
              } else if (absV >= 1000000) {
                  return { val: Math.round(val / 10000) / 100 + "M", skipComma: true };
              } else if (absV >= 100000) {
                  return { val: Math.round(val), skipComma: false };
              }
              ...
              link: function (scope, elem, attrs, ngModelCtrl) {
                  ...
                  ngModelCtrl.$formatters.push(function (val) {
                      ...
                      if (!skipComma) {
                          ...
                          valFormat = addCommasToInteger(valFormat.toString(), decimals, groupSep);
                      }
