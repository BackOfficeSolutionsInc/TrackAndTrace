  ...
  function ($q, editableUtils) {
  	...
  	function EditableController($scope, $attrs, $element, $parse, editableThemes, editableIcons, editableOptions, $rootScope, $compile, $q) {
		 ...
		 */
  		...
  		self.absPos = function (obj) {
  			var bodyRect = document.body.getBoundingClientRect(),
			 elemRect = obj.getBoundingClientRect(),
			 offset = { y: elemRect.top - bodyRect.top, x: elemRect.left - bodyRect.left };
  			return offset;
  			//var p = {};
  			//p.x = obj.offsetLeft;
  			//p.y = obj.offsetTop;
  			...
  			//		//p.y = p.y - obj.offsetParent.scrollTop;
  		...
  		self.show = function () {
			...
			*/
  			...
  			//self.editorEl.css("position", "absolute");
  			//self.editorEl.css("left", pos.x + "px");
  			//self.editorEl.css("top", pos.y + "px");


  			var container = angular.element("<div class='item-wrapper place-right'></div>");
  			container.css("position", "absolute");
  			container.css("left", pos.x + "px");
  			container.css("top", pos.y + "px");
  			angular.element("body").append(container);
  			container.append(self.editorEl);
