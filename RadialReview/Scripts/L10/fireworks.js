...
function Firework(oC,startX,startY,burstX,burstY,burstType,nRadius,nParticles,nCircles,allowRandom,obeyBoundaries) {
  ...
  this.aniExplode = function() {
    ...
    if (typeof(soundManger)!=="undefined" && soundManager.ok()) {
...
function createFirework(nRadius,nParticles,nCircles,nBurstType,startX,startY,burstX,burstY,allowRandom,obeyBoundaries,selector) {
  ...
  fc.fireworks[fc.fireworks.length] = new Firework(document.getElementById('animationContainer'), startX, startY, burstX, burstY, nBurstType, nRadius, nParticles, nCircles, allowRandom, obeyBoundaries);
