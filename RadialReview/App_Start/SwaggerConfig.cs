		...
		public static void Register() {
			...
			GlobalConfiguration.Configuration
				.EnableSwagger(c => {
					...
					//
					//c.SingleApiVersion("v1", "Traction Tools API").Contact(x=>x.Url("https://traction.tools"));
					/*	.Description(@"
<h1 id=""Overview"">Overview</h1>
	<div class=""doc-section"">
		...
		< p > We make no guarantee about the stability of v0.Your applications may break at any time in the future. Use at your own risk.If you find any errors please contact us at<a href=""mailto:support@mytractiontools.com""> support@mytractiontools.com</a></p>
	</div>
			...
			<div class=""panel-body"">
				<code>curl -i -X GET -H ""Authorization:Bearer <b>YOUR_BEARER_TOKEN_HERE</b>"" 'https://traction.tools/api/v0/scorecard/items/'</code>
					...
					c.MultipleApiVersions(
					    ...
					    (vc) =>{
					        vc.Version("v1", "Traction Tools API - V1");
					        vc.Version("v0", "Traction Tools API - V0");
					    });
				...
				.EnableSwaggerUi(c => {
					...
					c.DocumentTitle("Traction Tools API");
