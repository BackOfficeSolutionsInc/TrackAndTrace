    ...
    public class PaymentPlan_Monthly : PaymentPlanModel {
        ...
        public virtual decimal DurationMultiplier() {
            ...
            switch (SchedulePeriod.Value) {
                case SchedulePeriodType.Monthly: return 1.0m;
                case SchedulePeriodType.Quarterly: return 3.0m;
                case SchedulePeriodType.Annual: return 12.0m;
                default: return 1.0m;
            }
        }
        ...
        public virtual string MultiplierDesc() {
            if (SchedulePeriod == null)
                return "";
            switch (SchedulePeriod.Value) {
                case SchedulePeriodType.Monthly: return "";
                case SchedulePeriodType.Quarterly: return " (Quarterly)";
                case SchedulePeriodType.Annual: return " (Annually)";
                default: return "";
            }
        }
        ...
        public override TimeSpan SchedulerPeriod() {
            ...
            switch (SchedulePeriod.Value) {
                case SchedulePeriodType.Monthly: return TimespanExtensions.OneMonth();
                case SchedulePeriodType.Quarterly: return TimeSpan.FromDays(365.25 / 4);
                case SchedulePeriodType.Annual: return TimeSpan.FromDays(365.25);
                default: return TimespanExtensions.OneMonth();
            }
        }
