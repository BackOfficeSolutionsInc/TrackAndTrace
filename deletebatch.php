...
<?php 
	...
	if(isset($_POST["submit"])){
		...
		$resultSet = $mysqli->query("SELECT * FROM tbl_trackandtrace WHERE batch_number AND TrackingNumber = '$search'");
			...
			<table class="table table bordered">
				<tbody  style="text-align: center">
					...
					<tr id="row<?php echo $rows["CustomerID"]; ?>" >
                        ...
                        <td><?php echo $rows["batch_number"]; ?></td>
						...
						<td><img src="images/bin.png" onclick="deleteById( <?php echo $rows['batch_number']; ?> )" /></td>
					</tr>
					<?php 		}
							}
					} ?>
...
function deleteById(id){
	...
	if (id == 0) { 
        ...
        xmlhttp.open("POST", "DeleteBybatch.php?id=" + id, true);
        xmlhttp.send();
    }
