...
namespace AmazonSDK {
    ...
    public class AmazonSQS {
        private string queueURL = Config.GetSQSQueueURL(); 
        AmazonSQSClient amazonSQSClient;
        public AmazonSQS() {
            amazonSQSClient = new AmazonSQSClient(Config.GetSQSAccessKey(), Config.GetSQSSecretKey(), RegionEndpoint.USWest2);
        }
        ...
        public async Task<bool> SendMessage(MessageQueueModel model) {
            ...
            try {
                ...
                AmazonSQSClient amazonSQSClient = new AmazonSQSClient(Config.GetSQSAccessKey(), Config.GetSQSSecretKey(), RegionEndpoint.USWest2);
