...
//	public class ChromaScale {

//		private string _mode;
//		private string _nacol;
...
//		private Dictionary<int,string> _colorCache;
//		private bool _useCache;
//		private double _gamma;

//		public ChromaScale(object colors, object positions) {
...
//			var k = (int)Math.Floor(t * 10000);
//			if (_useCache && _colorCache.ContainsKey(k)) {
//				col = _colorCache[k];
//			} else {
//				for(var i=0;i<_colors.Length;i++) {
//					var p = i / (_colors.Length - 1);
//					if (t <= p) {
//						col = _colors[i];
//						break;
//					}
					
//					if (t >= p && i == _colors.Length - 1) {
//						col = _colors[i];
//						break;
//					}
					
//					var p1 = (i + 1) / (_colors.Length - 1);
//					if (t> p && t < p1 ){
//						t = (t - p) / (p1 - p);
...
//			string Interpolate(string color1, string color2, double val);
//		}
//		protected Dictionary<string, IColorInterpolator> _interpolators = new Dictionary<string, IColorInterpolator>();



//		public string Interpolate(string color1, string color2, double val, string m) {
//			return _interpolators[m].Interpolate(color1,color2,val);
//		}
